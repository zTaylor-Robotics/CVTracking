...
configfile_name = "config_cache/tracker_config.ini"
...
if not os.path.isfile(configfile_name):
    ...
    #clear()
#    input("Press [ENTER] to begin trials..")
    tr = Track(cam_list, stream_enable, write_enable, object_aruco_ids)
    tr.project_tracker(participant_id, aruco_size)
